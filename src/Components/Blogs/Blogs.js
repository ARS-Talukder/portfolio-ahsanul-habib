                ...
                <Slide left>
                    <div className='my-12 lg:flex justify-center py-8 px-4 lg:p-4 rounded-xl' style={{ backgroundColor: "#e1e2e3" }}>
                        ...
                        <div className='lg:w-3/4'>
                            <h2 className='text-2xl font-bold underline text-center lg:text-left text-gray-600'><em>My Blog</em></h2>
                            <p className='font-bold text-justify lg:text-left text-gray-600 my-3'><em>{blog.slice(0, 250)}...</em></p>
